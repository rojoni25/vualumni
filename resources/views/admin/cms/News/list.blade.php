    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <a href="{{route('admin.cms.news.create')}}" class="btn btn-success">Add New</a>
            </div>
                            ...
                            <tbody>
                                @forelse ($newses as $news)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="news-img mr-2">
                                                    <img alt="avatar"
                                                        style="object-fit:contain;height:100%; width:100%;"
                                                        src="{{ asset('storage/images/news/thumb/'.$news->thumbnail) }}">
                                                </div>
                                            </div>
                                        </td>
                                        {{-- <td>{{ $news->category }}</td>
                                        ...
                                        <td class="style-3">
                                            <form action="{{route('admin.cms.news.destroy',$news->id)}}" method="post" id="delete_{{$news->id}}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <ul class="table-controls">
                                                <li><a href="{{route('admin.cms.news.edit',$news->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                                                <li><a href="javascript:setModal('#delete_{{$news->id}}');"  class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash p-1 br-6 mb-1"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                @empty
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteNewsLabel">Are You Sure?</h5>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            <span>Do you really want to delete this news?</span>
                        </div>
                    </div>
        ...
        c2 = $('#style-2').DataTable({
            headerCallback: function(e, a, t, n, s) {
                e.getElementsByTagName("th")[0].innerHTML =
                    '<label class="new-control new-checkbox checkbox-outline-info m-auto">\n<input type="checkbox" class="new-control-input chk-parent select-customers-info" id="news-all">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>'
            },
            columnDefs: [{
                targets: 0,
                width: "30px",
                ...
                render: function(e, a, t, n) {
                    return '<label class="new-control new-checkbox checkbox-outline-info  m-auto">\n<input type="checkbox" class="new-control-input child-chk select-customers-info" id="news-all">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>'
                }
            }],
            "oLanguage": {
                "oPaginate": {
