...
@section('content')
                        ...
                        <div class="user-info-list">
                            <div class="">
                                <ul class="contacts-block list-unstyled">
                                    ...
                                    <li class="contacts-block__item">
                                        <a href="mailto:{{ $associationMember->email }}"><svg
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="timeline-alter">
                            @forelse ($associationMember->ocupationsDesc as $ocupation)
                                <div class="item-timeline">
                                    <div class="t-meta-date">
                                        <p class="">{{ $ocupation->from_date->format('d M Y') }} -
                                            {{ $ocupation->continuing ? 'Present' : $ocupation->to_date->format('d M Y') }}
                                        </p>
                                    </div>
                                    <div class="t-dot">
                                    </div>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="3">{{ $associationMember->name }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="1">Name (Bangla):</td>
                                        <td colspan="3">{{ $associationMember->name_bangla }}</td>
                                    </tr>
                                    <tr>
                                        <td>Date of Birth:</td>
                                        <td>{{ $associationMember->dob->format('d M Y') }}</td>
                                        <td>Age:</td>
                                        <td>{{ $associationMember->dob->age }}</td>
                                    </tr>
                                    <tr>
                                        <td>Marital Status</td>
                                        <td>{{ $associationMember->maritial_status }}</td>
                                        <td>Spouse Name</td>
                                        <td>{{ $associationMember->spouse_name }}</td>
                                    </tr>
                                    <tr>
                                        <td>Children:</td>
                                        <td>{{ $associationMember->son_count }} Son(s)
                                            {{ $associationMember->daughter_count }} Daughter(s)</td>
                                        <td>Gender:</td>
                                        <td>{{ $associationMember->gender }}</td>
                                    </tr>
                                    <tr>
                                        <td>NID:</td>
                                        <td colspan="3">{{ $associationMember->nid }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div id="demo-test-gallery" class="demo-gallery proof-image text-center"
                                                ...
                                                <a class="" href="{{ asset($associationMember->nid_photo) }}"
                                                    data-size="1600x1068"
                                                    data-med="{{ asset($associationMember->nid_photo) }}"
                                                    data-med-size="1024x683"
                                                    data-author="{{ $associationMember->name }}">
                                                    <img src="{{ asset($associationMember->nid_photo) }}"
                                                        alt="image-gallery">
                                                    ...
                                                    @if ($associationMember->nid_approval == 'Approved' || $associationMember->nid_approval == 'Rejected')
                                                        <span
                                                            class="{{ $associationMember->nid_approval == 'Approved' ? 'approval-a' : 'approval-r' }}">{{ $associationMember->nid_approval == 'Approved' ? 'Approved' : 'Rejected' }}</span>
                                                    @endif
                                                </a>
                                            </div>
                                            @if ($associationMember->status != 'Approved')
                                                <div>
                                                    <a href="javascript:void();" data-toggle="modal"
                                                        data-target="#nidApproveModal"
                                                        class="btn btn-success mb-4 mr-2 {{ $associationMember->nid_approval == 'Approved' ? 'disabled' : '' }}"
                                                        title="Approve">
                                                    ...
                                                    <a href="javascript:void();" data-toggle="modal"
                                                        data-target="#nidDeclineModal"
                                                        class="btn btn-danger mb-4 mr-2 {{ $associationMember->nid_approval == 'Rejected' ? 'disabled' : '' }}"
                                                        title="Reject">
                                                        <div class="icon-container">
                                                            <svg style="height:17px; width:17px; color: white; margin:unset;"
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div id="demo-test-gallery" class="demo-gallery proof-image text-center"
                                                ...
                                                <a class="" href="{{ asset($associationMember->certificate) }}"
                                                    data-size="1600x1068"
                                                    data-med="{{ asset($associationMember->certificate) }}"
                                                    data-med-size="1024x683"
                                                    data-author="{{ $associationMember->name }}">
                                                    <img src="{{ asset($associationMember->certificate) }}"
                                                        alt="image-gallery">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 p-1">
                                ...
                                <div class="card bg-dark">
                                    <div class="card-body" style="line-height: 30px;">
                                        <div>
                                            <span>Membership:
                                            </span><span><b>{{ $associationMember->membership_type }}</b></span>
                                        </div>
                                        <div>
                                            <span>Payable Amount:
                                            </span><span><b>{{ $associationMember->membership_info->registration_fees }}/=</b></span>
                                        </div>
                                        <div>
                                            <span>Payment Status:
                                            </span><span><b>{{ $associationMember->payment_approval }}</b></span>
                                        </div>
                                        <div>
                                            <span>Payment Method:
                                            </span><span><b>{{ $associationMember->registrationPayment->method ?? 'Not Set' }}</b></span>
                                        </div>
                                        <div>
                                            <span>Payment Date:
                                        ...
                                        @if ($associationMember->registrationPayment)
                                            @forelse ($associationMember->registrationPayment->statement as $key => $statement)
                                                <div>
                                                    <span>{{ str_replace('_', ' ', $key) }}:
                                                    </span><span><b>{{ $statement ?? 'Not Set' }}</b></span>
                                                </div>
                                            @empty
                                            @endforelse
                                        @endif
                                        ...
                                        <div>
                                            <span>Confirmed By:
                                            </span><span><b>{{ $associationMember->registrationPayment->confirmedBy->name ?? 'Not Confrmed Yet' }}</b></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 p-1">
                                    <div class="card bg-dark ">
                                        <div class="card-body">
                                            <form
                                                action="{{ route('admin.association-members.payment-approve', $associationMember->id) }}"
                                                method="POST" id="payment_verification">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="method">Payment Method</label>
                                                    <select class="selectpicker form-control" name="method"
                                                ...
                                                <input class="btn btn-success" hidden type="submit"
                                                    value="Validate Payment" id="submitPayment">
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    @include('admin.applicants.forms.modal_forms');
@endsection
@push('scripts')
        ...
        $("#payment_method").change(function() {
            ...
            if ($("#payment_method").find(":selected").attr('opt-type') == "mft") {
                $(".stmt").append('<div class="form-group stmt mftfield">' +
                    ...
                    '<input type="text" class="form-control" name="statement[Transaction_ID]" placeholder="Transaction ID" required>' +
                    '</div>');
                ...
                $(".stmt").append('<div class="form-group stmt bankfield">' +
                    ...
                    '<input type="text" class="form-control" name="statement[Bank_Name]" placeholder="Bank Name" required>' +
                    '</div>' +
                    '<div class="form-group stmt bankfield">' +
                    '<label for="statement[Branch]">Branch</label>' +
                    '<input type="text" class="form-control" name="statement[Branch]" placeholder="Branch" required>' +
                    '</div>');
            }
        })
    </script>
