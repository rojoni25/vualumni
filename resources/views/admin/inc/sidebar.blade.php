        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    ...
                    @can('admin.association-members.index')
                    <li class="menu {{ ($category_name === 'applicants') ? 'active' : '' }}">
                        <a href="#applicants" data-active="{{ ($category_name === 'applicants') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'applicants') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
