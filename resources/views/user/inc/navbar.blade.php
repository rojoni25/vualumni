    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="flex-row text-center navbar-item theme-brand">
            <li class="nav-item theme-logo">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('aavu_logo_02.png') }}" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{ route('home') }}" class="nav-link"> ALUMNI ASSOCIATION OF VARENDRA UNIVERSITY(AAVU) </a>
            </li>
        </ul>

        {{-- @if ($category_name != 'starter_kits')
            <ul class="flex-row ml-auto navbar-item ml-md-0">
        ...
        <ul class="flex-row navbar-item ml-md-auto">
            ...
            <li class="nav-item dropdown message-dropdown">
                ...
                <div class="p-0 dropdown-menu position-absolute" aria-labelledby="messageDropdown">
                    {{-- <div class="">
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                    ...
                    <img src="{{ asset(Auth::user()->profile_photo_path ?? Auth::user()->membershipInfo->photo) }}"
                        alt="avatar">
                </a>
...
<div class="sub-header-container">
    <header class="header navbar navbar-expand-sm">
            ...
            <li>
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            {{ set_breadcrumb($title, $category_name) }}
                        </ol>
                    </nav>
        ...
        <ul class="flex-row ml-auto navbar-nav ">
